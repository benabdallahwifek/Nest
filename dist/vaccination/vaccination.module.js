...
const vaccination_schema_1 = require("./schemas/vaccination.schema");
...
VaccinationModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: vaccination_schema_1.Vaccination.name, schema: vaccination_schema_1.VaccinationSchema }]),
        ],
