...
BabyModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: baby_schema_1.Baby.name, schema: baby_schema_1.BabySchema }]),
        ],
        controllers: [baby_controller_1.BabyController],
        providers: [baby_service_1.BabyService],
        exports: [baby_service_1.BabyService],
    })
], BabyModule);
